...
class EuropeanPricing(PricingBase):
    ...
    def calculate_prices(self, time_to_maturity=0.0):
        ...
        d_1 = self._calculate_d1(time_to_maturity)
        d_2 = self._calculate_d2(time_to_maturity)
        ...
        if valid:
            ...
            if cols > 1:
                ...
                for item in table:
                    ...
                    self.calculate_prices(decimaldays_to_maturity)
                    ...
                    print(f'{key}, {decimaldays_to_maturity:.5f}, ${value:.2f}')

        return table


    def _calculate_d1(self, time_to_maturity=0.0):
    ...
    def _calculate_d2(self, time_to_maturity=0.0):
